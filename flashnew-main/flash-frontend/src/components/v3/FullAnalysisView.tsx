...
import { MILESTONE_TIMELINES } from '../../config/constants';
                        ...
                        {getShortTermRecommendations(data, fundingStage).map((rec: any, i: number) => (
                          <div key={i} className="recommendation-card urgent">
                            <div className="rec-header">
                              ...
                              <span className="timeline">{config?.milestoneTimelines?.immediate || '0-3 months'}</span>
                            </div>
                            <h5>{rec.title}</h5>
                            <p>{rec.description}</p>
                        ...
                        {getMediumTermRecommendations(data, fundingStage).map((rec: any, i: number) => (
                          <div key={i} className="recommendation-card medium">
                            <div className="rec-header">
                              ...
                              <span className="timeline">{config?.milestoneTimelines?.short_term || '3-6 months'}</span>
                            </div>
                            <h5>{rec.title}</h5>
                            <p>{rec.description}</p>
                          </div>
