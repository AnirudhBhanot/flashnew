...
const ParticleField: React.FC = () => {
  ...
  const particleTimeoutsRef = useRef<NodeJS.Timeout[]>([]);
  ...
  useEffect(() => {
    ...
    const createParticle = () => {
      ...
      const timeout = setTimeout(() => particle.remove(), 30000);
    ...
    return () => {
      ...
      // Clear all particle removal timeouts
      ...
      >
        <div className="hero-content-v2">
          ...
          >
            ...
            >
              Get realistic assessments using honest ML models across 45 key metrics
            </motion.p>
          ...
          <div className="floating-metrics-v2">
            <MetricCard value="4" label="AI Models" delay={0.9} />
            <MetricCard value="100K" label="Companies Analyzed" delay={1.1} />
            <MetricCard value="Real" label="Predictions" delay={1.3} />
