...
const Advantage: React.FC = () => {
  ...
  const [formData, setFormData] = useState<AdvantageData>({
    ...
    networkEffects: data.advantage?.networkEffects || false,
    hasDataMoat: data.advantage?.hasDataMoat || false,
    regulatoryAdvantage: data.advantage?.regulatoryAdvantage || false,
    techDifferentiation: data.advantage?.techDifferentiation || 3,
    switchingCosts: data.advantage?.switchingCosts || 3,
    brandStrength: data.advantage?.brandStrength || 3,
    scalability: data.advantage?.scalability || 3,
    productStage: data.advantage?.productStage || '',
    uniqueAdvantage: data.advantage?.uniqueAdvantage || '',
  });
