...
const Capital: React.FC = () => {
  ...
  const [formData, setFormData] = useState<CapitalData>({
    totalRaised: data.capital?.totalRaised || '',
    cashOnHand: data.capital?.cashOnHand || '',
    monthlyBurn: data.capital?.monthlyBurn || '',
    lastValuation: data.capital?.lastValuation || '',
    primaryInvestor: data.capital?.primaryInvestor || '',
    hasDebt: data.capital?.hasDebt || false,
    debtAmount: data.capital?.debtAmount || '',
    fundingStage: data.capital?.fundingStage || '',
    annualRevenueRunRate: data.capital?.annualRevenueRunRate || '',
    monthlyRevenue: data.capital?.monthlyRevenue || '',
    hasRevenue: data.capital?.hasRevenue || false,
    runway: data.capital?.runway || '',
