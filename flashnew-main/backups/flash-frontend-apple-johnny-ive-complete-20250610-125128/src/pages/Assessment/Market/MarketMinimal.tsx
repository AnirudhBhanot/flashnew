...
const Market: React.FC = () => {
  ...
  const [formData, setFormData] = useState<MarketData>({
    ...
    sam: data.market?.sam || '',
    som: data.market?.som || '',
    marketGrowthRate: data.market?.marketGrowthRate || '',
    customerCount: data.market?.customerCount || '',
    customerConcentration: data.market?.customerConcentration || '',
    userGrowthRate: data.market?.userGrowthRate || '',
    netDollarRetention: data.market?.netDollarRetention || '',
    competitionIntensity: data.market?.competitionIntensity || 3,
    competitorCount: data.market?.competitorCount || '',
    revenueGrowthRate: data.market?.revenueGrowthRate || '',
    grossMargin: data.market?.grossMargin || '',
    ltvCacRatio: data.market?.ltvCacRatio || '',
  });
  ...
  const validate = (): boolean => {
    ...
    if (!formData.customerCount || Number(formData.customerCount) === 0) {
