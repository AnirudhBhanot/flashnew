...
function transformAssessmentToAPI(data: AssessmentData): any {
  ...
  return {
    ...
    // Product metrics (15 fields) - Using default values since product section removed
    retention_rate_monthly: 0.85,
    daily_active_users: 1000,
    monthly_active_users: 10000,
    product_market_fit_score: 3.5,
    feature_adoption_rate: 0.7,
    user_engagement_score: 3.5,
    time_to_value_days: 7,
    product_stickiness: 0.3,
    activation_rate: 0.6,
...
export const apiService = {
  ...
  async validateData(data: AssessmentData) {
    ...
    // Product section removed from CAMP structure
