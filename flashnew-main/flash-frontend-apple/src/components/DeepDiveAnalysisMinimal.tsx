...
import styles from './DeepDiveAnalysisMinimal.module.scss';

interface DeepDiveAnalysisMinimalProps {
  scores: {
    capital: number;
    advantage: number;
    market: number;
...
export const DeepDiveAnalysisMinimal: React.FC<DeepDiveAnalysisMinimalProps> = ({
  scores,
  assessmentData,
  insights
}) => {
