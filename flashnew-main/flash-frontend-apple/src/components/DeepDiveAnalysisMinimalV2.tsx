...
import styles from './DeepDiveAnalysisMinimalV2.module.scss';

interface DeepDiveAnalysisMinimalV2Props {
  scores: {
    capital: number;
    advantage: number;
    market: number;
...
export const DeepDiveAnalysisMinimalV2: React.FC<DeepDiveAnalysisMinimalV2Props> = ({
  scores,
  assessmentData,
  insights
}) => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h3 className={styles.title}>Deep Dive Analysis</h3>
        <p className={styles.subtitle}>
          Select any pillar below for detailed metrics and benchmarks
        </p>
      </div>
              ...
              <div className={styles.subScores}>
                {pillarData[selectedPillar as keyof typeof pillarData].subScores.map((subScore, index) => (
                  ...
                  >
                    ...
                    <p className={styles.subScoreDescription}>
