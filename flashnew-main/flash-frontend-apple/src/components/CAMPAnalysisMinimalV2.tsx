...
import styles from './CAMPAnalysisMinimalV2.module.scss';

interface CAMPAnalysisMinimalV2Props {
  scores: {
    capital: number;
    advantage: number;
    market: number;
...
export const CAMPAnalysisMinimalV2: React.FC<CAMPAnalysisMinimalV2Props> = ({ scores }) => {
  const campItems = [
    {
      key: 'capital',
      label: 'Capital',
