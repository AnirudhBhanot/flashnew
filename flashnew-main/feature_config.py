"""
Unified Feature Configuration for FLASH
Defines the canonical 45 features used across all models
"""

# CAMP Framework Feature Groups (45 total features)
...
PRODUCT_FEATURES = [
    ...
    'ltv_cac_ratio',
    'funding_stage'  # Added to make 45 total
]

# All 45 features combined
ALL_FEATURES = (
    CAPITAL_FEATURES + 
    ADVANTAGE_FEATURES + 
    MARKET_FEATURES + 
