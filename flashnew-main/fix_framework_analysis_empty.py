#!/usr/bin/env python3
"""
Fix the framework analysis returning empty or generic content by integrating DeepSeek
"""
...
def create_enhanced_framework_analysis():
    """Create an enhanced version of api_framework_intelligent.py with DeepSeek integration"""
...
async def generate_dynamic_framework_analysis(
    ...
    # Call DeepSeek
    analysis_text = await call_deepseek(prompt)
...
'''
    ...
    output_path = "/Users/sf/Desktop/FLASH/api_framework_intelligent_enhanced.py"
    with open(output_path, 'w') as f:
        f.write(content)
    
    print(f"✅ Created enhanced framework analysis API: {output_path}")
    print("\nKey improvements:")
    print("1. Integrated DeepSeek for dynamic framework analysis")
    print("2. Framework-specific prompts based on company context")
    print("3. Intelligent fallbacks for each major framework")
    print("4. Proper parsing of AI responses into structured format")
    print("5. Test endpoint for debugging: /api/frameworks/test/{framework_id}")
    
    # Create a backup of the original
    original_path = "/Users/sf/Desktop/FLASH/api_framework_intelligent.py"
    backup_path = "/Users/sf/Desktop/FLASH/api_framework_intelligent.py.backup"
    ...
    print("2. Test a specific framework: GET /api/frameworks/test/ansoff_matrix")
    print("3. The framework analysis should now show dynamic, company-specific content")

if __name__ == "__main__":
    create_enhanced_framework_analysis()